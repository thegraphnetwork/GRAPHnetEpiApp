...
#' library(tidyverse)
#' 
#' n_contacts <- 400  ## must be an even number
#' n_cases <- 50
...
#' 
#' 
#' openxlsx::write.xlsx(liste_contacts_sample, here::here("data/liste_contacts_sample_CIV.xlsx"))
#' openxlsx::write.xlsx(suivi_contacts_sample, here::here("data/suivi_contacts_sample_CIV.xlsx"))
#' 
