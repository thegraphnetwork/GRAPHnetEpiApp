...
#' library(tidyverse)
#' 
#' n_contacts <- 2000  ## must be an even number
#' n_cases <- 100
#' outbreak_how_many_days_ago <- 50
#' 
#' 
...
#'     "Brazzaville",              "Djiri",
#'     "Brazzaville",              "Madibou",
#'     "Brazzaville",              "Makelele",
#'     "Brazzaville",              "Mfilou",
#'     "Brazzaville",           "Moungali",
#'     "Brazzaville",           "Ouenze",
#'     "Brazzaville",            "Talangai",
#'     "Brazzaville",           "Ile_Mbamou",
#'     "Pointe_Noire",           "Loandjili",
#'     "Pointe_Noire",            "Lumumba",
#'     "Pointe_Noire",             "Mongo_mpoukou",
#'     "Pointe_Noire",             "Mvoumvou",
#'     "Pointe_Noire",             "Ngoyo",
#'     "Pointe_Noire",             "Tchiamba_nzassi",
#'     "Pointe_Noire",           "Tie_Tie"
#'   ) %>%
...
#' 
#' 
#' openxlsx::write.xlsx(liste_contacts_sample, here::here("data/liste_contacts_sample_COG.xlsx"))
#' openxlsx::write.xlsx(suivi_contacts_sample, here::here("data/suivi_contacts_sample_COG.xlsx"))
#' 
