#'---
#'title: "03.3: server_functions_for_SAMPLE.R"
#'output:
...
contacts_list_sample <-
  rio::import(here::here("data/liste_contacts_sample_SAMPLE.xlsx"))

follow_up_list_sample <-
  rio::import(here::here("data/suivi_contacts_sample_SAMPLE.xlsx"))
